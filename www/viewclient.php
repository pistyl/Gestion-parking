  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="gerent.html">ajouter gérent</a>
        </li>
        <li class="nav-item">
...
<div data-role="header" data-theme="a">
            <h2 style="color:; background-color: ;text-align: center;" >abonnées<span id="dert"></span></h2>
        </div>
  ...
  $pass='';
   $db='compte';
    ...
    while($row=mysqli_fetch_assoc($result)){
    	...
    	echo "{$row['prenom']}  {$row['nom']}  {$row['mail']}  {$row['mat']} v<br>";
    }
